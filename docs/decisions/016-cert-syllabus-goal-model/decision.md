...
| 11    | Course as peer primitive to Syllabus -- 3 tables (course, course_step, goal_course), BC, courseLens + courseWithCertOverlayLens, YAML pipeline + seed | Shipped (PRs #713, #721, #728, #730, #732, #734, #736, #737; doc fixes #731, #739) -- per [course-primitive WP](../../work-packages/course-primitive/) and the "Refinement: Course as a peer primitive (2026-05-08)" section above |
