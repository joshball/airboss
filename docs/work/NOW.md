...
Single entry point for "what should I work on?" in airboss. Refresh date: 2026-05-02 (hangar-invite-flow shipped + drizzle migration baseline reset + WP-SUB ratified + Cluster H closure WP shipped end-to-end + sources-review fixer wave all merged + legacy SOURCES retirement closed).

## Just shipped (2026-05-02 -- hangar-invite-flow, drizzle baseline reset, WP-SUB, Cluster H, sources-review fixer wave)
