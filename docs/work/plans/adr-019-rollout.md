...
| 3 | reference-cfr-ingestion-bulk | [WP](../../work-packages/reference-cfr-ingestion-bulk/) | _pending_ | 🟧 |
...
| 2026-04-27 | 3 | CFR bulk ingestion WP authored + implementation (PR pending). |
