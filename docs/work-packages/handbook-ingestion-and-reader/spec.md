...
| faa_page_start  | integer     | NULL                                                                     | First FAA-printed page (e.g., 12 for `12-7`). Used in display + locator.                                    |
| faa_page_end    | integer     | NULL                                                                     | Last FAA-printed page in the range. NULL when unknown.                                                      |
