...
9. **Documentation sweep.** Every doc that mentions `source.pdf`, `source.xml`, or the old layout is rewritten:
   ...
   - [docs/.archive/design-docs/section-extraction-prompt-strategy/design.md](../../.archive/design-docs/section-extraction-prompt-strategy/design.md)
...
| [docs/.archive/design-docs/section-extraction-prompt-strategy/design.md](../../.archive/design-docs/section-extraction-prompt-strategy/design.md) lines 177, 206, 208, 496 | Update prompt text and verification examples.                                                                                                                                                                                                                                                                                                            |
