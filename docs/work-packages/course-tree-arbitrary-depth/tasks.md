...
| Add fixture `course/courses/_fixtures/3-level-tree/`                                                                                      | `course/courses/_fixtures/3-level-tree/`        | Minimal 3-level shape: one section, one lesson, two leaves. Used in unit + e2e tests                                                         |
