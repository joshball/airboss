...
- `bun run check` exits 0; `bun test libs/sources/` passes; `bun run handbook-corpus-ingest` exits 0 against the on-disk derivatives for all three handbooks.
