...
- [ ] Run `bun run sources register handbooks --doc=phak --edition=8083-25C` against the on-disk derivatives. Verify exit 0 and the report shows expected entry count.
