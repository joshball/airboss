# Archived: FIRC-era Platform Roadmap (2026-04-26)

> **Archived 2026-04-26.** Superseded by [docs/platform/ROADMAP.md](../../platform/ROADMAP.md) (post-pivot). The phasing below describes FIRC course delivery, FAA submission, and the four-app FIRC stack (sim/hangar/ops/runway). Per [PIVOT.md](../../platform/PIVOT.md), the platform now grows by surface (study, spatial, audio, etc.), and FIRC submission is dormant unless a content pack ships.
>
> **Current source of truth:** [docs/platform/ROADMAP.md](../../platform/ROADMAP.md), [docs/platform/MULTI_PRODUCT_ARCHITECTURE.md](../../platform/MULTI_PRODUCT_ARCHITECTURE.md).
>
...
The pre-pivot platform roadmap, phased around FIRC course delivery and FAA submission. Outdated app names (sim/hangar/ops/runway) and broken links to archived hangar docs preserved for context.
