...
created: '2026-04-23'
shipped_prs: [78, 79, 80, 81, 82, 83, 84, 85, 86, 114, 183, 190]
tags: [umbrella, themes]
---

# Theme System Overhaul

Umbrella WP. Coordinates the 10 sub-packages listed below (nested under this directory). All sub-packages shipped between PR #78 (2026-04-23) and PR #190 (2026-05-08). This doc is the program-level INDEX; it ships nothing of its own. Per-package specs, tasks, and reviews live in `01-theme-foundation/` through `10-theme-picker-shared-lib/`.
