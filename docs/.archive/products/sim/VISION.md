# Archived: FIRC-era Sim Vision (2026-04-26)

> **Archived 2026-04-26.** This describes a FIRC course player for instructors to renew their certificates. The airboss `apps/sim/` is a different product: a flight-dynamics simulator (hand-rolled C172 FDM, scenarios, debrief, scoring -- see ADR 015). The FIRC course-player concept survives only as the future `apps/firc/` migration target from airboss-firc.
>
> **Current source of truth:** [docs/products/sim/VISION.md](../../../products/sim/VISION.md), [docs/work-packages/flight-dynamics-sim/spec.md](../../../work-packages/flight-dynamics-sim/spec.md), [ADR 015](../../../decisions/015-sim-surface-loose-coupling.md).
>
...
The pre-pivot sim vision -- a FIRC course player.
