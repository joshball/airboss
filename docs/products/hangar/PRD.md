...
status: current
date: 2026-04-26
supersedes: ../../.archive/firc-era/products/hangar/PRD.md
---
...
For the why, see [VISION.md](VISION.md). For the FIRC-era PRD (425 lines of dormant submission machinery), see [.archive/firc-era/products/hangar/PRD.md](../../.archive/firc-era/products/hangar/PRD.md).
...
| Auth gate         | Layout-level `requireRole(AUTHOR | OPERATOR | ADMIN)`; `/users` tightens to `ADMIN`-only              | [hangar-scaffold](../../work-packages/hangar-scaffold/spec.md)                |
...
**Status:** dormant. **Trigger to reawaken:** a FIRC content pack (or any Part 141 / WINGS module) ships and demands FAA-traceable submission. **Where the work lives:** [.archive/firc-era/products/hangar/](../../.archive/firc-era/products/hangar/). **Decision record:** [ADR 017](../../decisions/017-firc-compliance-dormant.md).
