...
const aliases = {
	...
	'@ab/bc-ingest-review/schema': resolve('./libs/bc/ingest-review/src/schema.ts'),
	'@ab/bc-ingest-review/server': resolve('./libs/bc/ingest-review/src/server.ts'),
	'@ab/bc-ingest-review': resolve('./libs/bc/ingest-review/src/index.ts'),
	...
	'@ab/sources/server': resolve('./libs/sources/src/server.ts'),
