...
references:
  - source: AC 00-2
    detail: Advisory Circular Checklist, Appendix 2 -- the subject-series numbering scheme
    note: The authoritative source for the AC subject-series prefixes. The document itself is cancelled, but Appendix 2 is the historical record of how the numbering was designed to mirror the 14 CFR subchapter structure.
  - source: 14 CFR
    detail: Title 14 part structure -- Parts 1, 21, 23, 43, 61, 91, 121, 135, 141, 150, and others
    note: The AC subject series mirror the CFR part numbers. Part 61 maps to the 61-series ACs, Part 91 to the 91-series, Part 150 to the 150-series. The mirror is the whole point of the scheme.
  - source: drs.faa.gov
...
4. **The general bucket.** Look at the last problem number: **AC 00-6**. There is no 14 CFR "Part 00." So what is the 00-series for? Reason it out: if the numbered series mirror specific CFR parts, the 00-series must be the catch-all for material that is not tied to one part. AC 00-6 is in fact "Aviation Weather," a general-knowledge handbook-style document that no single CFR part owns. Likewise the 20-series covers aircraft and airworthiness topics broadly, sitting near the airworthiness parts (21, 23, 25, 43) without being a one-to-one copy of any of them.
...
| AC 91-73       | 90/91  | General operating rules | Parts 91 and 135 Single Pilot Procedures During Taxi Operations |
...
| AC 00-6        | 00     | General                 | Aviation Weather                                                |

Note AC 91-73: it carries the 91 because it is about Part 91 operations, even though the broad series label is "90, air traffic and general operating rules." The series numbers are families; specific ACs take the part number they most directly support.
...
1. **Predict from number.** Given each number cold, name the subject area: AC 61-65, AC 91-73, AC 20-138, AC 150-5300-13, AC 00-6.

2. **Name the prefix.** Given a subject, name the series prefix: airman certification; airports; general aviation weather; aircraft and airworthiness; general operating and flight rules.

3. **Explain the mirror.** Why does AC 61-65 begin with 61? Answer in one sentence that mentions 14 CFR.

4. **The 00 question.** Why is AC 00-6 in the 00-series and not in some numbered series? What does the 00-series hold?
...
3. You also see "AC 00-46." The prefix is 00. What does that tell you, and what does it NOT tell you, about the subject?
