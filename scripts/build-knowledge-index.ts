 ...
 * author-facing output; it's rewritten in-place on each successful build and
 * is git-ignored (purely derived, no consumers -- regenerate locally).
 */
...
function renderGraphIndex(nodes: readonly ParsedNode[], summary: CoverageSummary): string {
	const lines: string[] = [];
	lines.push('<!-- Auto-generated by `bun run db build`. Do not edit by hand. -->');
	lines.push('<!-- Git-ignored derived artifact; regenerate locally via `bun run db build`. -->');
