...
export const SOURCE_KIND_BY_TYPE: Readonly<Record<ReferenceSourceType, SourceKind>> = {
	...
	[REFERENCE_SOURCE_TYPES.AVWX]: SOURCE_KINDS.TEXT,
	[REFERENCE_SOURCE_TYPES.IPH]: SOURCE_KINDS.TEXT,
	[REFERENCE_SOURCE_TYPES.RMH]: SOURCE_KINDS.TEXT,
	[REFERENCE_SOURCE_TYPES.AIH]: SOURCE_KINDS.TEXT,
	[REFERENCE_SOURCE_TYPES.HFH]: SOURCE_KINDS.TEXT,
	[REFERENCE_SOURCE_TYPES.GFH]: SOURCE_KINDS.TEXT,
	[REFERENCE_SOURCE_TYPES.BFH]: SOURCE_KINDS.TEXT,
