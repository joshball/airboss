...
/**
 * `<HeartbeatTicker>` -- mounts on a reader page and POSTs a reading-time
 ...
 * above the floor.
 *
 * Originally lived in `apps/flightbag/src/lib/`. Moved into `@ab/library` so
 * `<ReaderLayout>` can mount it conditionally on every reader surface, not
 * only the handbook section reader. See WP-FLIGHTBAG-READER-UX phase 1.
 */
