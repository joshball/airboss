...
/**
 * The honest Layer-2 placeholder for `census`-mode adapters.
 *
 ...
 * Phase-3 tasks. This is a spec-mandated honest placeholder
 * (design.md "Placeholder honesty"), not a code shortcut -- the gaps array
...
export function layerTwoPending(corpusLabel: string): { message: string; href: string } {
	return {
		message:
			...
			`No gaps are shown here because fabricating them before the analysis is authored would be dishonest.`,
