...
export const load: PageServerLoad = async (event) => {
	...
	// every shared/bookmarked URL with a silently-empty chip. `resolveActorForChip`
	// routes id-shaped values to the exact-match lookup and falls back to
	// the typeahead search only for hand-edited free-text values.
