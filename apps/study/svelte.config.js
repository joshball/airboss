...
const config = {
	...
	kit: {
		...
		alias: {
			...
			'@ab/wx-charts': '../../libs/wx-charts/src/index.ts',
			'@ab/wx-charts/server': '../../libs/wx-charts/src/server.ts',
			'@ab/wx-charts/*': '../../libs/wx-charts/src/*',
			'@ab/wx-engine': '../../libs/wx-engine/src/index.ts',
			'@ab/wx-engine/server': '../../libs/wx-engine/src/server.ts',
			'@ab/wx-engine/*': '../../libs/wx-engine/src/*',
			'@ab/wx-explain': '../../libs/wx-explain/src/index.ts',
			'@ab/wx-explain/*': '../../libs/wx-explain/src/*',
			'@ab/wx-drill': '../../libs/wx-drill/src/index.ts',
			'@ab/wx-drill/server': '../../libs/wx-drill/src/server.ts',
			'@ab/wx-drill/*': '../../libs/wx-drill/src/*',
			'@ab/bc-wx-practice': '../../libs/bc/wx-practice/src/index.ts',
			'@ab/bc-wx-practice/server': '../../libs/bc/wx-practice/src/server.ts',
			'@ab/bc-wx-practice/*': '../../libs/bc/wx-practice/src/*',
		},
		env: {
			dir: '../../',
		},
