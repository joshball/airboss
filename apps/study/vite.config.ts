...
// Honor $PORT so the e2e suite can boot this app on PORTS.STUDY_E2E
// alongside a running dev server. Falls back to the canonical dev port.
const port = Number(process.env.PORT ?? PORTS.STUDY);
