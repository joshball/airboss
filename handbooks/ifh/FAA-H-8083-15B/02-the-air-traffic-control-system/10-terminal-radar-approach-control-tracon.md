...
chapter_number: 2
section_title: Terminal Radar Approach Control (TRACON)
faa_pages: 2-6
section_number: 10
...
up the transponder and initiates tracking as soon as it detects
...
the two are combined on the controller’s scope. [Figure 2-9]
