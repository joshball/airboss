...
chapter_number: 2
section_title: Center Approach/Departure Control
faa_pages: 2-7
section_number: 13
...
System data area
Untracked target
Nonselect code with mode C
Trackball position symbol
(inhibited when not in use)
Targets in suspend status
Coast/suspend tabular list
Readout area
Preview area
Arrival/departure tabular list
Tracked target center
Controlled partial data block
Partial data as seen by S
if worked by N
Tracked primary target
Untracked target select
code with mode C
Figure 2-9. The top image is a display as seen by controllers in an air traffic facility. It is an ARTS III (Automated Radar Terminal
System). The display shown provides an explanation of the symbols in the graphic. The lower figure is an example of the Digital Bright
Radar Indicator Tower Equipment (DBRITE) screen as seen by tower personnel. It provides tower controllers with a visual display
of the airport surveillance radar, beacon signals, and data received from ARTS III. The display shown provides an explanation of the
symbols in the graphic.
Outer marker
Radar
Indicates downwind alignment
guide for 100L and 28R
Delta 4210
Aircraft number: N1388V
Type aircraft: Cessna 421
Alt: 4,000’ Descending, 180 knots
Obstacles
VOR location
Airport center
Runway 16
Indicates downwind alignment
guide for 100R and 28L

Various controls for the tower operator to select
Runway’s 100R
Runway’s 100L
Scale: one line = 1 mile

Figure 2-10. A portion of the New York area tower en route list (from the A/FD).
