...
chapter_number: 10
section_title: Airport/Facility Directory (A/FD)
faa_pages: 10-2
section_number: 4
...
notices essential to flight are also included, such as landand-hold-short operations (LAHSO) data, the civil use of
