...
chapter_number: 6
section_title: Airplane Attitude Instrument Flying
faa_pages: 6-1..6-28
...
4000
130 4300
N-S E-W 23.0 120 Slip/skid indica 4t 2o 00r 2
1
110
4100
1 20
...
70
46 TAS 100KT 4300
Pitch indicator Heading indicator
200
VOR 1
1652
1
...
ALERTS
Figure 6-26. Performance instruments.</th><th></th><th></th></tr></thead><tbody><tr><td>Vertical speed indicator
Airspeed indicator</td><td></td><td></td></tr><tr><td>N-S E-W</td><td></td><td>NAV1 108.00 113.00 WPT _ _ _ _ _ _ DIS _ _ . _ NM DTK _ _ _° TRK 360° 134.000 118.000 COM1
NAV2 108.00 110.60 123.800 118.000 COM2
4000
130 4300
Slip/skid indicator 2
23.0 120 4200
1
110
4100
...
DME TUNING
Course deviation indicatVoOR r1 DME MODE NAV1
NAV section
audio panel
OAT 7°C XPDR 5537 IDNT LCL23:00:34
DME tuning window ALERTS</td><td>NAV frequency window COM controls Moving map
N NA AV V1 2 1 11 17 7. .6 90 0 1 11 17 7. .9 60 0 WPT _ _ _ _ _ _ DIS _ _ ._ NM DTK _ _ _° TRK 360°1 13 12 8. .6 57 25 5 1 12 30 2. .0 90 00 0 C CO OM M1 2 N NA AV V1 2 1 11 17 7. .6 90 0 1 11 17 7. .9 60 0 WPT _ _ _ _ _ _ D MI AS P_ -_ N. A_ VN IM G A TD IT OK N _ M A_ P_ ° TRK 360°1 13 12 8. .6 57 25 5 1 12 30 2. .0 90 00 0 C CO OM M1 2
130 44 30 00 00
2
120 4200
...
NAV cont9rols
90
lideslope/vertic80a l guidanc 2e i °n d
70
VOTARS 7 100 0 KT
...
<table><thead><tr><th>N NA AV V1 2 1 10 08 8. .0 00 0 1 11 13 0. .0 60 0 WPT _
130
120
110
1
...
TAS 106KT
OAT 7°C
Figure 6-29. Bank indicat</th><th></th><th>0°
10°</th><th>Avoi
One
is ass
This
...
most
being
and tr</th></tr></thead><tbody><tr><td></td><td>N NA AV V1 2 1 10 08 8. .0 00 0 1 11 13 0. .0 60 0 WPT _
130
120
110
1
...
OAT 7°C</td><td>20°
30°
_ _ _ _ _ DIS _ _ ._ NM DTK _ _ _°T TRK 360°T1 13 24 3. .0 80 00 04 51 11 1°8 8. . 0 00 00 0 C CO OM M1 2
60°
4000
4300
2
...
4300
VOR 1
XPDR 5537 IDNT LCL23:00:34</td><td>i
S
T
f
B
...
h
b
a</td></tr><tr><td></td><td></td><td></td><td>S
a
p</td></tr></tbody></table>
</div>

<div class="handbook-table" data-source="/handbooks/ifh/FAA-H-8083-15B/tables/tbl-6-11-untitled.html">
<table><thead><tr><th>8.00 113.00 W
8.00 110.60</th><th>PT _ _ _ _ _ _ DIS _ _ . _ NM DTK _ _ _° TRK 3</th><th>60° 134.000 118.000 COM1
...
<table><thead><tr><th>Slip/skid indicator
Altitude indicator
Vertical speed indicator</th><th></th><th></th></tr></thead><tbody><tr><td></td><td>Pitch Attitu</td><td>N NA AV V1 2 1 10 0A8 8i. .r0 0s0 0p e e d1 11 1 i3 0n. .d0 6i0 0catoWP rT _ _ _ _ _ _ DIS _ _ . _ NM DTK _ _ S_° l ip T /R sK k i d36 i0 n° di1 1c3 2a4 3t. .o0 8r0 00 0 1 11 18 8. .0 00 00 0 C CO OM M1 2
de
...
110 4100 1
1 60
g indicator 2300 100 9 4400000 20 0
90 3900
Artificial horizon Heading 1
80 3800
13.7 270°
2
70 4300
...
ALERTS</td></tr><tr><td>rspeed indicator
Headin
SCAN PATTERN</td><td></td><td></td></tr><tr><td>pattern should start with
irspeed indicator), then
altitude indicator/VSI),
p (slip/skid indicator),
own (heading indicator
ilot should return attenti
o the center (pitch
...
cator/V
23
23</th><th>A8 8i. .r0 0s0 0p e e d1 11 1 i3 0n. .d0 6i0 0catoWP rT _ _ _ _ _ _ DIS _ _
SI
130
.0 120
110
...
100
00 9
90</th><th>. _ NM DTK _ _ _° TRK 360° 134.000 1
Slip/skid indi1c2a3t.o8r00 1
4000
4300
4200
4100
...
44000000
2
3900</th><th></th></tr></thead><tbody><tr><td></td><td></td><td></td><td>4300
4200
4100
6
44000000
2
3900</td></tr><tr><td></td><td>Artificial horiz
80
13.7
70
46 TAS 100KT
...
<div class="handbook-table" data-source="/handbooks/ifh/FAA-H-8083-15B/tables/tbl-6-16-untitled.html">
<table><thead><tr><th>ge
dic
ll
th
ow
...
<div class="handbook-table" data-source="/handbooks/ifh/FAA-H-8083-15B/tables/tbl-6-17-untitled.html">
<table><thead><tr><th>what the associated airspeed, altitude, or heading
in 6 seconds for the Cirrus SR-20 and 10 seconds 4800
1900
-737 if the current rate is maintained. The example
n Figure 6-35 uses the color and data that represents Trend indicator shows 2
d vector for a Cirrus SR-20. The trend vector is not altitude will be approxi- 1800 1500
d if there is no change to the associated tape and the mately 1,780 ft in 6
1
mains constant [Figure 6-36] or if there is a failure seconds. 1700
portion of the system that would preclude the vector
16 40
ng determined. 1600 20
VSI arrow has moved up
150 to indicate a 1,500 fpm 1500 1 Note
rate of climb.
140 1400
1,500 fpm ÷ 60 sec = 25 ft 2
130 25 ft per sec x 6 sec = 150 ft
1 150 ft + 1,630 ft = 1,780 ft 4300
120
9
110 Figure 6-37. Altimeter trend indicators.
Airspeed trend indicator
shows airspeed will be Another advancement in attitude instrument flying is the
100
approximately 126 kts in turn rate trend indicator. As in the cases of airspeed, altitude,
6 seconds.
and vertical speed trend indicators, the turn rate trend
90
TAS 120KT indicator depicts what the aircraft’s heading will be in 6
seconds. While examining the top of the heading indicator,</th><th>4800
1900
2
Trend indicator shows
altitude will be approxi- 1800 1500
...
VSI arrow has moved up
1500 Note
to indicate a 1,500 fpm 1
rate of climb.
1400
1,500 fpm ÷ 60 sec = 25 ft 2
25 ft per sec x 6 sec = 150 ft
150 ft + 1,630 ft = 1,780 ft 4300</th></tr></thead><tbody><tr><td>120
9
110
Airspeed trend indicator
...
6 seconds.
90
TAS 120KT</td><td></td></tr></tbody></table>
</div>
