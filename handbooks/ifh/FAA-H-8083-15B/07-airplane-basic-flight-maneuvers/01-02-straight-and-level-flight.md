...
chapter_number: 7
section_title: Straight-and-Level Flight
faa_pages: 7-2
section_number: 1
subsection_number: 2
...
As the altimeter is added to the attitude indicator in a crosscheck, a pilot learns to recognize the rate of movement of
...
interpreted instantly for immediate control action in highperformance airplanes. On the other hand, a reasonably
...
Maintain rpm at 2,500, since a high power setting is
...
shows approximately two-and-a-half bar width nosehigh in straight-and-level flight.
...
Correcting with improper bank attitude. If correcting a
...
Confusion about the operation of trim devices that
...
varies according to the type of airplane. Apply light backelevator pressure to initiate and maintain the climb attitude.
...
If on a north heading and a turn is started to the east or
...
actually occurring.
When on an east or west heading, the compass indicates
...
south the number of degrees of latitude, minus normal rollout lead. [Figure 7-35]
...
Failure to cross-check the ASI as pitch changes
are made.
...
2.	 Start a 180° standard rate turn to the right at B. Rollout at C on the reciprocal of the heading originally
used at A.
...
Fly 1 minute on the original heading, adjusting the
