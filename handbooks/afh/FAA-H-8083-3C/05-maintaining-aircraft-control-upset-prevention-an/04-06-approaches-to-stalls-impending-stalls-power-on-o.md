...
chapter_number: 5
section_title: Approaches to Stalls (Impending Stalls), Power-On or Power-Off
faa_pages: 5-17
section_number: 4
subsection_number: 6
...
AOA once the stall warning device goes off, if installed, or recognizes other cues such as buffeting. The pilot should hold the nosedown control input as required to eliminate the stall warning. Then level the wings maintain coordinated flight, and then apply
