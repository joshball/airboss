...
chapter_number: 16
section_title: Jet Engine Basics
faa_pages: 16-1
section_number: 3
...
diameter and thinner blades of increasing pitch. The compression in each stage raises the air temperature and pressure. The highpressure hot air enters the combustion chamber where fuel is added. During engine start, igniters set the fuel air mixture on fire, after
