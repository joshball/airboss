...
attempt to simplify the discussion about this maneuver, the lazy eight can be loosely compared to the ground reference maneuver, Sturns across the road. Recall that S-turns across the road are made of opposing 180° turns. For example, first a 180° turn to the right,
...
pressure may be required to prevent the wings from overbanking while maintaining rudder pressure to cancel the effects of leftturning tendencies.
