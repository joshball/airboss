...
chapter_number: 25
section_title: 'Analyzed Surface Weather information refers to weather data from sources
  other than the currently approved ground-based ASOS and AWOS weather reporting systems.
  Alternate sources may include:'
faa_pages: 25-2
section_number: 3
