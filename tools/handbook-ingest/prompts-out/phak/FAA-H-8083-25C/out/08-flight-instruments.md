...
- Expected SHA-256: `c4d61c5c480a07e076a6cca9347ac20a578c6317583e8c9deb669c626e791b84`
...
`error: sidecar SHA-256 mismatch -- expected c4d61c5c480a07e076a6cca9347ac20a578c6317583e8c9deb669c626e791b84, got <observed>`
...
- Success:
  `ok: wrote {N} entries to handbooks/phak/FAA-H-8083-25C/08/_llm_section_tree.json (model: <self-reported>)`
- Failure:
...
1. Compute `shasum -a 256 handbooks/phak/FAA-H-8083-25C/08/_chapter_plaintext.txt` (or equivalent) and compare to
   `c4d61c5c480a07e076a6cca9347ac20a578c6317583e8c9deb669c626e791b84`. On mismatch, return the error status line above.
...
5. Write the JSON to `handbooks/phak/FAA-H-8083-25C/08/_llm_section_tree.json` (one trailing newline; no markdown
   fencing).
6. Write `handbooks/phak/FAA-H-8083-25C/08/_model_self_report.txt`
