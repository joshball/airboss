...
6. Write the JSON to `handbooks/phak/FAA-H-8083-25C/05/_llm_section_tree.json` (one trailing newline; no markdown
   fencing).
7. Write `handbooks/phak/FAA-H-8083-25C/05/_model_self_report.txt`
