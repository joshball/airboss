...
- Expected SHA-256: `0a2d12c2045178e3ccbbb26124ca05233bd5f6ac75fada59045c8ebfbcfa0a51`
...
`error: sidecar SHA-256 mismatch -- expected 0a2d12c2045178e3ccbbb26124ca05233bd5f6ac75fada59045c8ebfbcfa0a51, got <observed>`
...
- Success:
  `ok: wrote {N} entries to handbooks/phak/FAA-H-8083-25C/16/_llm_section_tree.json (model: <self-reported>)`
- Failure:
...
1. Compute `shasum -a 256 handbooks/phak/FAA-H-8083-25C/16/_chapter_plaintext.txt` (or equivalent) and compare to
   `0a2d12c2045178e3ccbbb26124ca05233bd5f6ac75fada59045c8ebfbcfa0a51`. On mismatch, return the error status line above.
...
5. Write the JSON to `handbooks/phak/FAA-H-8083-25C/16/_llm_section_tree.json` (one trailing newline; no markdown
   fencing).
6. Write `handbooks/phak/FAA-H-8083-25C/16/_model_self_report.txt`
