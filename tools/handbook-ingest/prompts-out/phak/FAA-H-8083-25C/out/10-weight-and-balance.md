...
```text
- L1 Introduction (10-1)
- L1 Weight Control (10-1)
  - L2 Effects of Weight (10-2)
  - L2 Weight Changes (10-2)
- L1 Balance, Stability, and Center of Gravity (10-2)
- L1 Effects of Adverse Balance (10-3)
- L1 Stability (10-3)
- L1 Control (10-3)
- L1 Management of Weight and Balance Control (10-4)
- L1 Terms and Definitions (10-4)
- L1 Principles of Weight and Balance Computations (10-5)
- L1 Weight and Balance Restrictions (10-6)
- L1 Determining Loaded Weight and CG (10-7)
- L1 Computational Method (10-7)
- L1 Graph Method (10-7)
- L1 Table Method (10-9)
- L1 Computations With a Negative Arm (10-10)
- L1 Computations With Zero Fuel Weight (10-10)
- L1 Shifting, Adding, and Removing Weight (10-10)
- L1 Weight Shifting (10-10)
- L1 Weight Addition or Removal (10-11)
- L1 Chapter Summary (10-11)
...
3. `handbooks/phak/FAA-H-8083-25C/10/_llm_disagreements.json`
...
- Success:
  `ok: wrote {N} entries to handbooks/phak/FAA-H-8083-25C/10/_llm_section_tree.json (model: <self-reported>{disagreements_suffix})`
...
6. Write the JSON section tree to `handbooks/phak/FAA-H-8083-25C/10/_llm_section_tree.json` (one trailing newline;
   no markdown fencing).
...
8. Write `handbooks/phak/FAA-H-8083-25C/10/_model_self_report.txt`
