...
- Expected SHA-256: `7625c3526e98b58591a5fdcd6920700dda0f332edc22324f5df6933084d068a7`
...
`error: sidecar SHA-256 mismatch -- expected 7625c3526e98b58591a5fdcd6920700dda0f332edc22324f5df6933084d068a7, got <observed>`
...
- Success:
  `ok: wrote {N} entries to handbooks/phak/FAA-H-8083-25C/07/_llm_section_tree.json (model: <self-reported>)`
- Failure:
...
1. Compute `shasum -a 256 handbooks/phak/FAA-H-8083-25C/07/_chapter_plaintext.txt` (or equivalent) and compare to
   `7625c3526e98b58591a5fdcd6920700dda0f332edc22324f5df6933084d068a7`. On mismatch, return the error status line above.
...
5. Write the JSON to `handbooks/phak/FAA-H-8083-25C/07/_llm_section_tree.json` (one trailing newline; no markdown
   fencing).
6. Write `handbooks/phak/FAA-H-8083-25C/07/_model_self_report.txt`
