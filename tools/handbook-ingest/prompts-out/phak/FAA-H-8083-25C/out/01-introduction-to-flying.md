...
- Expected SHA-256: `22b5172016585be4e9a218487e814dcf41f7f10506dc4e93e11a4cda9677da81`
...
`error: sidecar SHA-256 mismatch -- expected 22b5172016585be4e9a218487e814dcf41f7f10506dc4e93e11a4cda9677da81, got <observed>`
...
- Success:
  `ok: wrote {N} entries to handbooks/phak/FAA-H-8083-25C/01/_llm_section_tree.json (model: <self-reported>)`
- Failure:
...
1. Compute `shasum -a 256 handbooks/phak/FAA-H-8083-25C/01/_chapter_plaintext.txt` (or equivalent) and compare to
   `22b5172016585be4e9a218487e814dcf41f7f10506dc4e93e11a4cda9677da81`. On mismatch, return the error status line above.
...
5. Write the JSON to `handbooks/phak/FAA-H-8083-25C/01/_llm_section_tree.json` (one trailing newline; no markdown
   fencing).
6. Write `handbooks/phak/FAA-H-8083-25C/01/_model_self_report.txt`
