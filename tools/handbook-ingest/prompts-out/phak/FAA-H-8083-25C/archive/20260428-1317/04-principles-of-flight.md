...
- Expected SHA-256: `a092492fc2f11665a6efc59bbeda24eb85ebd52a06b54e7bdf7e1492ddd5c2f2`
...
`error: sidecar SHA-256 mismatch -- expected a092492fc2f11665a6efc59bbeda24eb85ebd52a06b54e7bdf7e1492ddd5c2f2, got <observed>`
...
- Success:
  `ok: wrote {N} entries to handbooks/phak/FAA-H-8083-25C/04/_llm_section_tree.json (model: <self-reported>)`
- Failure:
...
1. Compute `shasum -a 256 handbooks/phak/FAA-H-8083-25C/04/_chapter_plaintext.txt` (or equivalent) and compare to
   `a092492fc2f11665a6efc59bbeda24eb85ebd52a06b54e7bdf7e1492ddd5c2f2`. On mismatch, return the error status line above.
...
5. Write the JSON to `handbooks/phak/FAA-H-8083-25C/04/_llm_section_tree.json` (one trailing newline; no markdown
   fencing).
6. Write `handbooks/phak/FAA-H-8083-25C/04/_model_self_report.txt`
