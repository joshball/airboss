...
- Expected SHA-256: `4f38ccc92059ef4d0756586b85cdf9e5ffc3792a978e4082c63f74063a423d6b`
...
`error: sidecar SHA-256 mismatch -- expected 4f38ccc92059ef4d0756586b85cdf9e5ffc3792a978e4082c63f74063a423d6b, got <observed>`
...
- Success:
  `ok: wrote {N} entries to handbooks/phak/FAA-H-8083-25C/13/_llm_section_tree.json (model: <self-reported>)`
- Failure:
...
1. Compute `shasum -a 256 handbooks/phak/FAA-H-8083-25C/13/_chapter_plaintext.txt` (or equivalent) and compare to
   `4f38ccc92059ef4d0756586b85cdf9e5ffc3792a978e4082c63f74063a423d6b`. On mismatch, return the error status line above.
...
5. Write the JSON to `handbooks/phak/FAA-H-8083-25C/13/_llm_section_tree.json` (one trailing newline; no markdown
   fencing).
6. Write `handbooks/phak/FAA-H-8083-25C/13/_model_self_report.txt`
