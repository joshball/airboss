...
- Expected SHA-256: `254c36f8d84568c76358349efdfab8120406f9bab2ce415aec0517216017b9d4`
...
`error: sidecar SHA-256 mismatch -- expected 254c36f8d84568c76358349efdfab8120406f9bab2ce415aec0517216017b9d4, got <observed>`
...
- Success:
  `ok: wrote {N} entries to handbooks/phak/FAA-H-8083-25C/06/_llm_section_tree.json (model: <self-reported>)`
- Failure:
...
1. Compute `shasum -a 256 handbooks/phak/FAA-H-8083-25C/06/_chapter_plaintext.txt` (or equivalent) and compare to
   `254c36f8d84568c76358349efdfab8120406f9bab2ce415aec0517216017b9d4`. On mismatch, return the error status line above.
...
5. Write the JSON to `handbooks/phak/FAA-H-8083-25C/06/_llm_section_tree.json` (one trailing newline; no markdown
   fencing).
6. Write `handbooks/phak/FAA-H-8083-25C/06/_model_self_report.txt`
