...
- Expected SHA-256: `abf60126762d1a54dbeb3932a379f8bb6f5309915a3c1801510d89ca1ea8f2ec`
...
`error: sidecar SHA-256 mismatch -- expected abf60126762d1a54dbeb3932a379f8bb6f5309915a3c1801510d89ca1ea8f2ec, got <observed>`
...
- Success:
  `ok: wrote {N} entries to handbooks/phak/FAA-H-8083-25C/09/_llm_section_tree.json (model: <self-reported>)`
- Failure:
...
1. Compute `shasum -a 256 handbooks/phak/FAA-H-8083-25C/09/_chapter_plaintext.txt` (or equivalent) and compare to
   `abf60126762d1a54dbeb3932a379f8bb6f5309915a3c1801510d89ca1ea8f2ec`. On mismatch, return the error status line above.
...
5. Write the JSON to `handbooks/phak/FAA-H-8083-25C/09/_llm_section_tree.json` (one trailing newline; no markdown
   fencing).
6. Write `handbooks/phak/FAA-H-8083-25C/09/_model_self_report.txt`
