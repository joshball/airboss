...
- Expected SHA-256: `12b24a23e49d4e5ea68c66e21e4c9f37b48f94b2493a3686be0b8e155f762ebd`
...
`error: sidecar SHA-256 mismatch -- expected 12b24a23e49d4e5ea68c66e21e4c9f37b48f94b2493a3686be0b8e155f762ebd, got <observed>`
...
- Success:
  `ok: wrote {N} entries to handbooks/phak/FAA-H-8083-25C/11/_llm_section_tree.json (model: <self-reported>)`
- Failure:
...
1. Compute `shasum -a 256 handbooks/phak/FAA-H-8083-25C/11/_chapter_plaintext.txt` (or equivalent) and compare to
   `12b24a23e49d4e5ea68c66e21e4c9f37b48f94b2493a3686be0b8e155f762ebd`. On mismatch, return the error status line above.
...
5. Write the JSON to `handbooks/phak/FAA-H-8083-25C/11/_llm_section_tree.json` (one trailing newline; no markdown
   fencing).
6. Write `handbooks/phak/FAA-H-8083-25C/11/_model_self_report.txt`
