...
- Expected SHA-256: `818b191b3cd758234559d2a884427f5034cbbace41e529b64070baa6b80f0b61`
...
`error: sidecar SHA-256 mismatch -- expected 818b191b3cd758234559d2a884427f5034cbbace41e529b64070baa6b80f0b61, got <observed>`
...
- Success:
  `ok: wrote {N} entries to handbooks/phak/FAA-H-8083-25C/03/_llm_section_tree.json (model: <self-reported>)`
- Failure:
...
1. Compute `shasum -a 256 handbooks/phak/FAA-H-8083-25C/03/_chapter_plaintext.txt` (or equivalent) and compare to
   `818b191b3cd758234559d2a884427f5034cbbace41e529b64070baa6b80f0b61`. On mismatch, return the error status line above.
...
5. Write the JSON to `handbooks/phak/FAA-H-8083-25C/03/_llm_section_tree.json` (one trailing newline; no markdown
   fencing).
6. Write `handbooks/phak/FAA-H-8083-25C/03/_model_self_report.txt`
